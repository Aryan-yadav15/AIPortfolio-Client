...
const testimonials = [
  ...
  {
    quote: "This is going to be a major breakthrough. That is for sure. Because there is no single entity who is actually giving you all the connections. So if at all you are able to make it, then it is going to be surely a breakthrough.",
    name: "Head MEP",
